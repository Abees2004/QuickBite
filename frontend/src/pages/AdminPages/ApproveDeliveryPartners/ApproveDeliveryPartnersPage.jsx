...
const AproveDeliveryPartners = () => {
    ...
    useEffect(() => {
        ...
        axiosInstance.get(`/api/register/delivery-partner-requests/`,{timeout:5000})
            .then(res =>{
                setUsers(res.data)
            ...
            .catch(err =>{
                ...
                setError('Failed to load delivery partner requests.');
                }
...
export default AproveDeliveryPartners;