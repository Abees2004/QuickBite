                ...
                <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-gray-50">
                        <tr>
                            ...
                            <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Resturant Name</th> 
                        ...
                        {users.map((user) => {
                            ...
                            return (
                                <tr key={user.id} className="hover:bg-gray-50 transition duration-100">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{user.resturant}</td>
