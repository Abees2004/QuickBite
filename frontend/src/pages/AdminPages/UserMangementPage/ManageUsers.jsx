...
const ManageUsers = () => {
    ...
    useEffect(() => {
        setLoading(true)
        setError(null)
        axiosInstance.get(`/api/users/users-list/`,{timeout:5000})
            .then(res => {
    ...
    // Function to handle Block/Unblock action (updates local state after API call)
                ...
                <div className="flex-1 flex flex-col overflow-y-auto">
                    ...
                    <header className="bg-white p-4 md:p-6 shadow-md flex flex-col sm:flex-row justify-between items-start sm:items-center sticky top-0 z-10">
                        ...
                        <div className="flex items-center">
                            ...
                            {/* --- Page Title --- */}
                            <h1 className="text-xl md:text-3xl font-bold text-gray-800 mb-2 sm:mb-0">User Management 👥</h1>
                        </div>
