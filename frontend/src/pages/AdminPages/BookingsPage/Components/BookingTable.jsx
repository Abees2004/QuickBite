                ...
                <tbody className="bg-white divide-y divide-gray-200">
                    {orders.map(order => (
                        <tr key={order.id} className="hover:bg-gray-50 transition duration-100">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{order.restaurant.name}</td>
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                                <span className={`px-2 inline-flex text-xs ${getStatusColor(order.status)} leading-5 font-semibold rounded-full ${order.statusColor}`}>
                                    {(order.status)}
                                </span>
                            </td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <Link to={`/admin/bookings/${order.id}`} className='text-blue-500'>View</Link>             
                            </td>
                        </tr>
                    ))}
                </tbody>
